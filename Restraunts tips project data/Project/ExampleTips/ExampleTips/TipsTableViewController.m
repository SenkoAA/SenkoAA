...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSNumber *newPaidForFood = [NSNumber numberWithInt:(int)([paidForFood intValue] * currentCours / nativeCours)];
    ...
    cell.paidForFoodLabel.text = [newPaidForFood stringValue];
    return cell;
}
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"tipsSegue"]) {
        ...
        t.date = [object valueForKey:@"date"];
        NSNumber *num;
        num = [object valueForKey:@"foodQuality"];
        [t setFoodQuality:[num intValue]];
        num = [object valueForKey:@"serviceQuality"];
        [t setServiceQuality:[num intValue]];
        num = [object valueForKey:@"serviceSpeed"];
        [t setServiceSpeed:[num intValue]];
        num = [object valueForKey:@"restrauntAtmosphere"];
        [t setRestrauntAtmosphere:[num intValue]];
        t.restrauntKey = [object valueForKey:@"restrauntKey"];
        num = [object valueForKey:@"paidForFood"];
        [t setPaidForFood:[num intValue]*currentCours/nativeCours];
        tipsDVC.tips = t;
