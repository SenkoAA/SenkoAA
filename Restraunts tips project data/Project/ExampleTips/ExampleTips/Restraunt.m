...
- (NSString *)createRestrauntFullName {
    NSMutableString *restrauntFullName = [[NSMutableString alloc] init];
    NSString *addressSeparatedString = @", ";
    [restrauntFullName appendString:_country];
    [restrauntFullName appendString:addressSeparatedString];
    [restrauntFullName appendString:_city];
    [restrauntFullName appendString:addressSeparatedString];
    [restrauntFullName appendString:_street];
    [restrauntFullName appendString:addressSeparatedString];
    [restrauntFullName appendString:_homeNumber];
    [restrauntFullName appendString:addressSeparatedString];
    [restrauntFullName appendString:_restrauntName];
    return restrauntFullName;
}
